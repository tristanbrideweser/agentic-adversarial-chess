...
from move_translator.board_geometry import GraveyardAllocator, ReserveRegistry
from move_translator.move_decomposer import (
    PickPlaceTask,
    decompose_move,
    task_queue_to_json,
...
class TestStandardMove:
    ...
    def test_grasp_height_matches_piece_type(self):
        from move_translator.board_geometry import get_piece_geometry
        board = make_board()
        move = chess.Move.from_uci("e2e4")
        g, r = fresh()
        tasks = decompose_move(board, move, g, r)
