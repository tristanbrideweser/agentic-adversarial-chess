...
BOARD_SURFACE_Z: float = 0.780      # m — top face of the board in world frame
SQUARE_SIZE: float = 0.05625           # m — one square edge
...
def square_to_world(square: str, z_override: float | None = None) -> WorldPose:
    ...
    x = A1_X + rank_idx * SQUARE_SIZE
    y = A1_Y + file_idx * SQUARE_SIZE
